            ...
            <section className="flex w-full p-5 h-screen">
                ...
                <div className="w-2/3 flex flex-col gap-10 bg-gray-100 p-10 rounded-md">
                    ...
                    <div className="flex w-full items-center justify-center">
                        <a href="/" className="border p-2 text-center rounded-full shadow border-teal-800/40 w-full  text-teal-500  text-sm hover:underline hover:text-teal-600  hover:bg-teal-800/20 transition hover:scale-98">Reset Password?</a>
                    </div>
                </div>
            </section>
        </>
